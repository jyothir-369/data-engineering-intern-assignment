...
Project Structure
textdata-engineering-intern-assignment/
├── data/
...
Directory: output/
Files Generated: result_AAPL.csv, result_AMD.csv, result_AMZN.csv, etc.
...
❌ No external technical analysis libraries (e.g., TA-Lib) allowed

How to Run

Place the input dataset at: data/stock_data.csv
Install dependencies:Bashpip install -r requirements.txt
Run the processing script from the project root:Bashpython src/process_data.py
