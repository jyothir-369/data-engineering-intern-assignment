...
⚠️ Early rows may contain NaN values due to insufficient historical data — this is expected behavior.
...
Files Generated:
result_AAPL.csv, result_AMD.csv, result_AMZN.csv, etc.
...
❌ No external technical analysis libraries (e.g., TA-Lib)
